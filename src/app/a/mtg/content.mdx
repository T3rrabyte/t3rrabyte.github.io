...
_Magic: The Gathering_ is a trading card game from 1993 in which you build a deck to play against other players. This article will not serve as an introduction to Magic, but rather to deck building for Magic. If you are not already familiar with the game, this article will not be helpful for you.
...
The _goal_ of the deck (also referred to as the _strategy_, _plan_, _win condition_, or _mission statement_) is a statement of the way that the deck intends to win the game. In the words of Magic designer Gavin Verhey, it is the difference between a deck and a pile of cards. Some things you might want to include in your mission statement are as follows:
