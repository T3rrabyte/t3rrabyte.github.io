...
- The return value of the fragment shader represents the color of the fragment in _color space_, which organizes the red, green, blue, and alpha values of the color on the interval $[0,1]$.
