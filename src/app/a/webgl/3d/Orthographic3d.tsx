...
import { brokenPositions, brokenColors } from "./f.ts";
...
export default function Orthographic3d(
	...
	return AnimatedCanvas((canvas: HTMLCanvasElement): FrameRequestCallback => {
		...
		const positionBuffer: Buffer = new Buffer(gl, brokenPositions);
		const colorBuffer: Buffer = new Buffer(gl, brokenColors);
