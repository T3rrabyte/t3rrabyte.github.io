...
- [World view projection matrix](/a/webgl/3d): a product of a view projection matrix and a world matrix; a matrix that transforms vertices to appear from the point of view of a camera.
