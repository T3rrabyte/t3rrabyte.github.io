...
import imageBlur from "./image-blur.png";
...
Now that we've detected all of the edges, we can finally detect the _contours_. Contours are curves that join all of the continuous points with the same intensity. They can be thought of as the subset of edges that outline things.
