...
Like numbers, matrices can be multiplied together.
Unlike numbers, however, matrices are not commutative; changing the order of transformation matrices being multiplied together also changes the order that the transformations are applied in.
