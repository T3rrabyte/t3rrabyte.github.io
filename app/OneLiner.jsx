...
const oneLiners = [
	<span key={1}>Also check out <Link href="https://griff.pw/">griff.pw</Link>!</span>,
	<span key={2}>Also check out <Link href="https://ty.business/">ty.business</Link>!</span>,
	<span key={3}>Also check out <Link href="https://www.xanycki.art/">xanycki.art</Link>!</span>,
