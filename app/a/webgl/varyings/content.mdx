...
You may need to read the previous article about [attributes](/a/webgl/uniforms) in order to understand this one.
...
Once WebGL starts to rasterize a primitive, the value of the varying is interpolated between the values set on each
...
The next article is about [transformation](/a/webgl/transformation).
