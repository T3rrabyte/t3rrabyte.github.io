...
With Umbra, the following line of code is equivalent to the block above.
...
data from `positionBuffer` in intervals of $2$. With Umbra, the following line of code is equivalent to the block above.
...
In Umbra, an extra argument can be passed to the `VAO` constructor to apply indices.
