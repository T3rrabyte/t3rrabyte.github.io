...
Most of the WebGL API is dedicated to setting up state for the shader program. A typical program that uses the WebGL
...
The next article walks through a minimal ["Hello, world!"](/a/webgl/hello-world) WebGL API program.
