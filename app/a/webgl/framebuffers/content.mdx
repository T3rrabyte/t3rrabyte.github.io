...
With Umbra, framebuffer binding points are not necessary.
...
be bound when the render function is called. With Umbra, this can be accomplished with the `bind` method.
