...
Umbra does this step automatically when linking shader programs.
...
Umbra automatically determines the correct setter function, so the following line has the same effect:
