...
The fragment shader multiplies the fragment position by the inverse of the view projection matrix, effectively undoing the view
projection. It then manually divides the $x$, $y$, and $z$ components by the $w$ component, which is usually automatically done
