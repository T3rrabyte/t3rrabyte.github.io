import { AttributeState, Buffer, clearContext, Color, Program, resizeContext, Texture2D, TextureFilter, TextureFormat, UniformValue, VAO } from "@lakuna/umbra.js";
...
export default function UmbraDataTextures({ ...props }) {
