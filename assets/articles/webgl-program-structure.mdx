...
summary: A typical format for a WebGL API program.
---
# Program Structure
...
[uniforms](/articles/webgl-uniforms).

Most of the WebGL API is dedicated to setting up state for
the shader program. A typical program using the WebGL API
...
["Hello, world!"](/articles/webgl-hello-world) WebGL API
program.
